...
INSERT INTO `routines` VALUES (1,'Push Pull Legs | Calisthenics',3,'https://www.hevyapp.com/wp-content/uploads/larry-crayton-ICwuKvw9QJk-unsplash-1.jpg','The \"Push, Pull, Legs\" (PPL) workout routine is a popular training split that divides exercises into three main categories: push, pull, and legs. This type of routine is often used in weightlifting, but it can be adapted for calisthenics as well.',0,'PPL'),(2,'Bro Split | Calisthenics',4,'https://www.hevyapp.com/wp-content/uploads/larry-crayton-ICwuKvw9QJk-unsplash-1.jpg','A \"bro split\" typically refers to a weightlifting training split where you train different muscle groups on different days throughout the week.',0,'Bro Split'),(3,'Bro Split | Weights',4,'https://www.workoutforless.co.uk/cdn/shop/articles/luis-reyes-mTorQ9gFfOg-unsplash_2_640x.jpg?v=1657122621','A \"bro split\" typically refers to a weightlifting training split where you train different muscle groups on different days throughout the week.',1,'Bro Split');
